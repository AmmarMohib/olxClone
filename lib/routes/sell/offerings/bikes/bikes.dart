...
class BikesDetails extends StatefulWidget {
  final String category;
  const BikesDetails({super.key, required this.category});

  @override
  State<BikesDetails> createState() => _BikesDetailsState();
}

class _BikesDetailsState extends State<BikesDetails> {
            ...
            child: Column(
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  widget.category == "bikes & motorcycles" ?  Padding(
                   ...
                   widget.category == "bikes & motorcycles" || widget.category == "scooty & scooters" ? Padding(
                      padding: const EdgeInsets.only(left: 15, top: 30),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                    ...
                    widget.category == "scooty & scooters" ? Padding(
                      padding: const EdgeInsets.only(left: 15, top: 30),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
